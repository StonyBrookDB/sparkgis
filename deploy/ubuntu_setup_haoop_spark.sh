...
echo "$(tput setaf 1)$(tput setab 7)Setting up Spark requires manual configuration. Please refer to $(tput setaf 5)setup_spark.sh$(tput setaf 1) for details $(tput sgr 0)"
