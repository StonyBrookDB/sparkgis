package sparkgis.core.executionlayer;
/* Java imports */
...
public class SparkSpatialJoin implements Serializable{
    ...
    public SparkSpatialJoin(DataConfig config1, DataConfig config2, Predicate predicate, int partitionSize){
	...
	// JavaRDD<Tuple2<Integer, Iterable<String>>> resRDD = 
	//     new JavaRDD<Tuple2<Integer, Iterable<String>>>(JavaPairRDD.toRDD(results), results.classTag());
	// return resRDD.map(new Function<Tuple2<Integer, Iterable<String>>, SPJResult>(){
	// 	public SPJResult call(Tuple2<Integer, Iterable<String>> t){
	// 	    return new SPJResult(t._1(), t._2());
	// 	}
	//     });
