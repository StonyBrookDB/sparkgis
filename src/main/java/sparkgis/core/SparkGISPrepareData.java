...
public class SparkGISPrepareData implements Serializable
{
    private final DataConfig dataConfig;
    
    public SparkGISPrepareData(String dataName)
    {
     ...
     */
    public DataConfig execute(JavaRDD<SpatialObject> spatialData){
