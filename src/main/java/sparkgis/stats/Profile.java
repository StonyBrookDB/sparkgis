...
public class Profile
{
    ...
    public static void heatmaps(String jID, IO spIn, List<String> caseIDs, List<String> algos, Predicate predicate, HMType hmType, int partitionSize, IO spOut){
	long start = System.nanoTime();
	//sparkgis.SparkGISMain.callHeatMap(jID, spIn, caseIDs, algos, predicate, hmType, partitionSize, spOut);
